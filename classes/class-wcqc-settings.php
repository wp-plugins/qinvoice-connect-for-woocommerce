				...
				<tbody>
					...
					<tr>
						...
						<td>
							...
							<span class="description">
								<?php _e( 'eg. Your order: {order_id} (you can also use {order_number})', 'woocommerce-qinvoice-connect' ); ?>
							</span>
						</td>
					</tr>
					<tr>
			...
			<table class="form-table">
				<tbody>
					...
					<tr>
						...
						<td>
								<?php
									$gw = new WC_Payment_Gateways();
									if ( $available_gateways = $gw->get_available_payment_gateways() ) {
										?>
										...
										foreach ( $available_gateways as $gateway ) {
											...
											<option value="<?php echo $gateway->id; ?>" <?php  if(get_option( WooCommerce_Qinvoice_Connect::$plugin_prefix . 'exclude_payment_method' ) == $gateway->id){ echo 'SELECTED'; } ?>><?php echo $gateway->get_title(); ?></option>
